...
class Ui_page_two(object):
    def setupUi(self, page_two):
        ...
        self.widget.setMaximumSize(QSize(190, 16777215))
        ...
        self.verticalLayout.addWidget(self.widget_2, 0, Qt.AlignLeft)
        ...
        self.horizontalLayout_5.addWidget(self.label_4, 0, Qt.AlignLeft)
        ...
        self.verticalLayout.addWidget(self.widget_5, 0, Qt.AlignLeft)
        ...
        self.endTime.setDateTime(QDateTime(QDate(2025, 8, 12), QTime(16, 0, 0)))
        ...
        self.verticalLayout.addWidget(self.widget_6, 0, Qt.AlignLeft)
        ...
        self.shMin.setMinimumSize(QSize(60, 0))
        self.shMin.setMaximumSize(QSize(60, 16777215))
        ...
        self.shMax.setMinimumSize(QSize(60, 0))
        self.shMax.setMaximumSize(QSize(60, 16777215))
        ...
        self.backTestBtn.setMaximumSize(QSize(150, 16777215))
        ...
        self.avg_ret.setMaximumSize(QSize(70, 16777215))
        ...
        self.avg_days.setMaximumSize(QSize(70, 16777215))
